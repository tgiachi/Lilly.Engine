...
public static class InputExtensions
{
    ...
    public static ButtonState LeftButton(this MouseState state)
        => state.IsButtonPressed(MouseButton.Left)
               ? ButtonState.Pressed
    ...
    public static ButtonState MiddleButton(this MouseState state)
        => state.IsButtonPressed(MouseButton.Middle)
               ? ButtonState.Pressed
               : ButtonState.Released;
    ...
    public static ButtonState RightButton(this MouseState state)
        => state.IsButtonPressed(MouseButton.Right)
               ? ButtonState.Pressed
               : ButtonState.Released;
    ...
    public static ButtonState XButton1(this MouseState state)
        => state.IsButtonPressed(MouseButton.Button4)
               ? ButtonState.Pressed
               : ButtonState.Released;
    ...
    public static ButtonState XButton2(this MouseState state)
        => state.IsButtonPressed(MouseButton.Button5)
               ? ButtonState.Pressed
               : ButtonState.Released;
}
